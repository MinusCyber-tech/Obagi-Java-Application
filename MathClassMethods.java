...
public class MathClassMethods{
	public static void main(String[] args){
		...
		System.out.printf("The rounded is %d%n" ,Math.round(num1));
		...
		System.out.printf("The max number is %d%n" ,Math.max(number3,number4));
		...
		double areaOfCircle = Math.PI * Math.pow(radius,2) * Math.PI;
